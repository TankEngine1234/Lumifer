export function fallbackPredict(indices: VegetationIndices, colorData: ColorData): NPKResult {
  ...
  // 💡 Add a telemetry array to track the "Why"
  ...
  if (exg < thresholds.nitrogen.exgDeficient) {
    ...
    telemetry.push(`[N-Stress] ExG dropped to ${exg.toFixed(2)} (Threshold: ${thresholds.nitrogen.exgDeficient}) -> Indicating severe canopy chlorosis.`);
  }
