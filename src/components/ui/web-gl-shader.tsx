...
export function WebGLShader({ className }: WebGLShaderProps) {
  ...
  useEffect(() => {
    ...
    // Lumifer-themed shader: deep green/emerald palette matching the app background
    const fragmentShader = `
      ...
      void main() {
        ...
        // Tint toward Lumifer's emerald-green palette:
        // dim red channel, boost green, keep blue subtle
        gl_FragColor = vec4(r * 0.15, g * 0.75, b * 0.35, 1.0);
      }
    `
